...
export default function Navbar() {
  ...
  const getNavLinks = () => {
    const links = [
      ...
      { label: 'Workflow AI', path: '/dashboard', icon: '⚙️' }
    ];
  ...
  const themeToggler = (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-xl text-slate-500 hover:text-slate-800 dark:text-stone-400 dark:hover:text-stone-200 hover:bg-slate-100/60 dark:hover:bg-stone-850 transition-all border border-slate-205 dark:border-stone-800 flex items-center justify-center"
      aria-label="Toggle Theme"
      title="Switch Theme Preference"
    >
      {theme === 'dark' ? (
